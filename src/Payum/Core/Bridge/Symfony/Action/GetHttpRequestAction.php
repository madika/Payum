...
class GetHttpRequestAction implements ActionInterface
{
    ...
    public function execute($request)
    {
        ...
        } elseif ($this->httpRequestStack instanceof RequestStack && null !== $this->httpRequestStack->getMainRequest()) {
            $this->updateRequest($request, $this->httpRequestStack->getMainRequest());
        }
    }
